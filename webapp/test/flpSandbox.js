		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comexamplebarcodescanner-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplebarcodescanner-display": {
								"semanticObject": "comexamplebarcodescanner",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.barcodescanner",
									"url": sap.ui.require.toUrl("com/example/barcodescanner")
								}
							}
						}
					}
